...
export default function SidebarGroup({menuGroup}: {menuGroup: SideNavItemGroup}) {
    ...
    const menuGroupStyle = ' py-4 tracking-[0.1rem] font-medium uppercase text-sm text-[#A5A1AA]';
    return (
        <>
           <h3 className={menuGroupStyle}>{!toggleCollapse ? menuGroup.title : <div className="border-t border-white w-full"></div>}</h3>
           {
